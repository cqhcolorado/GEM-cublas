...
c  test splines with very small grids: nx=2, nx=3
      ...
      real :: zctrl  ! control info (not yet used)
      !  presence of real argument assures name change for r8 mapping
      !  (pspltsub.for -> r8pspltsub.for) as desired.

      real :: x1(2),xpkg(2,4)
      real :: xx1(3),xxpkg(3,4)
      real :: xxx1(4),xxxpkg(4,4)
      real :: s1da(2,2),s1db(2,2),h1da(2,2)
      real :: s1dc(2,3),s1dd(2,4),szp40
      real :: test,zbc1,zbc2
      real :: feval0(5),feval1(5),feval2(5)
      real :: feval0p(5),feval1p(5),feval2p(5)
      integer :: ibc1,ibc2
      integer :: ier,idum,iwarn,ii,jj

      real, dimension(5) :: xeval ! =(/ 0.0, 0.25, 0.50, 0.75, 1.00 /)
